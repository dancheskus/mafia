...
export const StyledNavMenu = styled.div<{ tutorialEnabled?: boolean }>`
  ${({ tutorialEnabled }) => css`
    position: relative;
    ...
    .navi {
      ...
      &_nav {
        ...
        top: 0;
        right: -3000px;
        z-index: ${tutorialEnabled ? 3610 : 200};
...
export const AppSettings = styled.div<{ hide?: boolean; tutorialEnabled?: boolean }>`
...
export const MenuItems = styled.div<{ hide: boolean }>`
