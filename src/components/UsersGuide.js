...
const steps = [
  ...
  { content: 'Нажмите на кнопку пару раз, чтобы узнать номер игрока', position: 'left' },
  {
    title: 'Музыка',
    content:
  ...
  },
  {
    ...
    content: 'В ночное время кнопками сверху можно ставить звук на паузу, а также включать следующую композицию.',
    position: 'top',
  },
  {
    title: 'Раздача ролей',
