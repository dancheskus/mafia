export const switchAppMusic = () => ({ type: 'SWITCH_APP_MUSIC' });
export const switchTimerSounds = () => ({ type: 'SWITCH_TIMER_SOUNDS' });
export const switchMafiaTimer = () => ({ type: 'SWITCH_MAFIA_TIMER' });
